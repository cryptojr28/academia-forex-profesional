  ...
  const renderNews = () => (
    <div className="news-section">
                ...
                <div className="analysis-content">
                  ...
                  <div className="analysis-meta">
                    ...
                    <span className="ai-confidence">
                      Confianza IA: {analysis.ai_confidence}%
                    </span>
                  </div>
                </div>
              </div>
      ...
      <div className="news-tips">
        <h3>💡 Tips para Trading de Noticias</h3>
        <div className="tips-grid">
          <div className="tip">
            <h4>🚨 Alto Impacto</h4>
            <p>NFP, decisiones de bancos centrales, GDP</p>
            <div className="tip-advice">
              <strong>Estrategia:</strong> Evita operar 30min antes/después
            </div>
          </div>
          <div className="tip">
            <h4>⚠️ Medio Impacto</h4>
            <p>PMI, inflación, empleo</p>
            <div className="tip-advice">
              <strong>Estrategia:</strong> Opera con stops más amplios
            </div>
          </div>
          <div className="tip">
            <h4>📊 Bajo Impacto</h4>
            <p>Discursos, datos secundarios</p>
            <div className="tip-advice">
              <strong>Estrategia:</strong> Trading normal con precaución
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="calculator">
          ...
          <div className="calc-inputs">
            ...
            <div className="input-group">
              ...
              <input type="number" placeholder="2" max="10" />
            </div>
            <div className="input-group">
              <label>Par:</label>
              <select>
        ...
        <div className="risk-rules">
          ...
          <div className="rules-list">
            <div className="rule">
              ...
              <p>Nunca arriesgues más del 2% por trade</p>
            </div>
            <div className="rule">
              <span className="rule-number">2</span>
              <p>Siempre usa Stop Loss</p>
            </div>
            <div className="rule">
              <span className="rule-number">3</span>
              <p>Ratio Risk/Reward mínimo 1:2</p>
            </div>
            <div className="rule">
              <span className="rule-number">4</span>
              <p>Máximo 3 trades simultáneos</p>
            </div>
            <div className="rule">
              <span className="rule-number">5</span>
              <p>Registra todos tus trades</p>
            </div>
          </div>
        </div>
      </div>
